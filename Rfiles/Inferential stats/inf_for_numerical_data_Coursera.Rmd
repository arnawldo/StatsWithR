...
nc %>%
  group_by(habit) %>%
  summarise(mean_weight = mean(weight), size = n())
```
<ul>
  <li>random assignment</li>
  <li>sample size less than 10% of population</li>
  <li>sample greater 30</li>
</ul>
...
The difference in sample means between weight of babies of smokers and non smokers is significant.
...
```
Young mom age cutoff is 34, because this is the maximum value of younger moms' age. Plus, the minimum age for mature mother's is 35.
