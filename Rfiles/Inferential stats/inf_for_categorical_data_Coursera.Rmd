...
# p-hat minus upeer or lower limit of ci
0.0499-0.0364
```
...
# dataset for Kenya
ky12 <- atheism %>%
  filter(nationality == "Kenya" , atheism$year == "2012")

#dataset for Turkey
tk12 <- atheism %>%
  filter(nationality == "Turkey" , atheism$year == "2012")

# ci for kenya
inference(y = response, data = ky12, statistic = "proportion", type = "ci", method = "theoretical", success = "atheist")

# ci for turkey
inference(y = response, data = tk12, statistic = "proportion", type = "ci", method = "theoretical", success = "atheist")
...
# nums <- 0
# 
# for (country in unique(atheism$nationality)) {
#   
#   if (length(levels(as.factor(atheism[atheism$nationality==country,]$year))) == 2) 
#   {
#     
#   infe <- inference(y = response, x = year, data = atheism[atheism$nationality==country,], statistic = 'proportion', type = 'ht', null = 0, alternative = 'twosided', method = 'theoretical', success = 'atheist')
#   if (infe$p_value < 0.05) {
#     nums <- nums + 1
#   }
#   }
# }
